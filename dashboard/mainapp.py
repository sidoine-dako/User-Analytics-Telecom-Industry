...
st.sidebar.markdown('This dasboard was designed to communicate with the stakeholders of TellCo company in order to share the main insights with them.')
...
st.subheader('Top handset manufacturer')
...
st.subheader('Top handset type by manufacturer')
